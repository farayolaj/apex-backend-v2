...
class NotificationController extends BaseController
{
    ...
    public function getNotifications()
    {
        ...
        $notifications = $this->notificationManager->getUnreadNotifications('users_new', $userId, $perPage, $offset);
        $totalUnread = $this->notificationManager->countUnreadNotifications('users_new', $userId);
        $data = [
            'paging' => [
                'page' => (int)$page,
    ...
    public function markAsRead()
    {
        ...
        if ($this->notificationManager->markNotificationsAsRead('users_new', $userId, $ids)) {
