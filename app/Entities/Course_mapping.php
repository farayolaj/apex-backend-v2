...
class Course_mapping extends Crud
{
	...
	static $typeArray = array('course_id' => 'int', 'programme_id' => 'int', 'semester' => 'int', 'course_unit' => 'int', 'course_status' => 'varchar', 'level' => 'text', 'mode_of_entry' => 'text', 'pass_score' => 'int', 'pre_select' => 'tinyint');
	/*this is a dictionary that map a field name with the label name that will be shown in a form*/
	static $labelArray = array('id' => '', 'course_id' => '', 'programme_id' => '', 'semester' => '', 'course_unit' => '', 'course_status' => '', 'level' => '', 'mode_of_entry' => '', 'pass_score' => '', 'pre_select' => '');
...
<textarea id='mode_of_entry' name='mode_of_entry' class='form-control' required>$value</textarea>
	...
	public function searchCourseLists($course, $level, $semester, $programme = null): array
	{
       ...
       left join staffs on staffs.id=users_new.user_table_id where (courses.code like '%$course%' or courses.title like '%$course%') and course_mapping.semester = ? and courses.active = '1' ";
		if ($programme) {
