 ...
 * And it represent the model of the request_type table
 */
class Request_type extends Crud
{
	 ...
	 * @var array
	 */
	public static $nullArray = ['name', 'slug', 'is_auditable', 'updated_at'];
	 ...
	 * @var array
	 */
	public static $typeArray = ['name' => 'varchar', 'slug' => 'varchar', 'is_auditable' => 'tinyint', 'active' => 'tinyint', 'created_at' => 'timestamp', 'updated_at' => 'timestamp'];
	 ...
	 * @var array
	 */
	public static $labelArray = ['id' => '', 'name' => '', 'slug' => '', 'is_auditable' => '', 'active' => '', 'created_at' => '', 'updated_at' => ''];

	/**
	 * Associative array of fields in the table that have default value
	 * @var array
	 */
	public static $defaultArray = ['is_auditable' => '1', 'active' => '1', 'created_at' => 'current_timestamp()'];
	 ...
	 * @var array
	 */
	public static $tableAction = ['delete' => 'delete/request_type', 'edit' => 'edit/request_type'];
	...
	public function getIs_auditableFormField($value = '')
	{
		return "<div class='form-group'>
		<label for='is_auditable'>Is Auditable</label>
		<input type='text' name='is_auditable' id='is_auditable' value='$value' class='form-control' required />
	</div>";
	}
