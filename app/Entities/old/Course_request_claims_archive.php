...
* And it represent the model of the course_request_claims_archive table
*/
class Course_request_claims_archive extends Crud {

/** 
* This is the entity name equivalent to the table name
* @var string
*/
protected static $tablename = "Course_request_claims_archive"; 

/** 
* This array contains the field that can be null
* @var array
*/
public static $nullArray = ['request_no','title','user_id','request_id','amount','description','beneficiaries','deduction','withhold_tax','vat','stamp_duty','total_amount','request_status','project_task_id','feedback','date_approved','updated_at','action_timeline','request_from','stage','voucher_document','deduction_amount','retire_advance_doc','rejected_by','admon_reference','claims_request_data','claims_request_data_items'];
...
* @var array
*/
public static $uniqueArray = ['request_no'];
...
* @var array
*/
public static $tableAction = ['delete' => 'delete/course_request_claims_archive', 'edit' => 'edit/course_request_claims_archive'];
...
public function getRetire_advance_docFormField($value = ''){
	return "<div class='form-group'>
		<label for='retire_advance_doc'>Retire Advance Doc</label>
		<input type='text' name='retire_advance_doc' id='retire_advance_doc' value='$value' class='form-control' required />
	</div>";
} 

public function getRejected_byFormField($value = ''){
	return "<div class='form-group'>
		<label for='rejected_by'>Rejected By</label>
		<input type='text' name='rejected_by' id='rejected_by' value='$value' class='form-control' required />
	</div>";
} 

public function getAdmon_referenceFormField($value = ''){
	return "<div class='form-group'>
		<label for='admon_reference'>Admon Reference</label>
		<input type='text' name='admon_reference' id='admon_reference' value='$value' class='form-control' required />
	</div>";
} 

public function getClaims_request_dataFormField($value = ''){
	return "<div class='form-group'>
		<label for='claims_request_data'>Claims Request Data</label>
		<input type='text' name='claims_request_data' id='claims_request_data' value='$value' class='form-control' required />
	</div>";
} 

public function getClaims_request_data_itemsFormField($value = ''){
	return "<div class='form-group'>
		<label for='claims_request_data_items'>Claims Request Data Items</label>
		<input type='text' name='claims_request_data_items' id='claims_request_data_items' value='$value' class='form-control' required />
	</div>";
} 
...
protected function getRequest(){
	...
	$resultObject = new \App\Entities\Request($result[0]);
	return $resultObject;
}
...
protected function getProject_task(){
	...
	$resultObject = new \App\Entities\Project_task($result[0]);
	return $resultObject;
}
