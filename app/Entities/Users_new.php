...
class Users_new extends Crud
{
    ...
    public function getUserInfoWithDepartment(int $userID, string $table, string $userType='staff')
    {
        $query = "SELECT b.*,a.id as user_id,a.user_login as username, c.name as department_name from users_new a 
		join {$table} b on b.id = a.user_table_id
