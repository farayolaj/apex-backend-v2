...
<textarea id='entry_mode_to_include' name='entry_mode_to_include' class='form-control' required>$value</textarea>
    ...
    public function initPayment($student, $channel, $payment = null, $transaction = null, $amount = null, $serviceCharge = null, $preselectedPack = null)
    {
        if ($channel == 'remita') {
            ...
            $trans = $remita->initPayment($student, $payment, $transaction, $amount, $serviceCharge, $preselectedPack);
            return $trans;
        }
    }
    ...
    public function partInitPayment($student, $channel, $payment = null, array $param = [], $transaction = null)
    {
        if ($channel == 'remita') {
            $remita = \CodeIgniter\Config\Factories::libraries('Remita');
            $trans = $remita->partInitPayment($student, $payment, $param, $transaction);
            return $trans;
        }
    }
    ...
    public function getPaymentDetails($student, $channel, $payment = null, $transaction = null)
    {
        if ($channel == 'remita') {
            $remita = \CodeIgniter\Config\Factories::libraries('Remita');
            $trans = $remita->getRemitaDetails($student, $payment, $transaction);
            return $trans;
        }
    }
    ...
    public function customInitPayment(object $users, string $channel, array $param, $transaction = null)
    {
        if ($channel == 'remita') {
            $remita = \CodeIgniter\Config\Factories::libraries('Remita');
            $trans = $remita->customInitPayment($users, $param, $transaction);
            return $trans;
        }
    }
    ...
    public function studentCustomInitPayment(string $channel, array $param, $transaction = null)
    {
        if ($channel == 'remita') {
            $remita = \CodeIgniter\Config\Factories::libraries('Remita');
            $trans = $remita->studentCustomInitPayment($param, $transaction);
            return $trans;
        }
    }
