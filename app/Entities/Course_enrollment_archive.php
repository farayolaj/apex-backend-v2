...
/**
		...
		*/
		...
		{
protected static $tablename='Course_enrollment_archive';
/* this array contains the field that can be null*/
static $nullArray=array('ca_score' ,'exam_score' ,'total_score' ,'date_deleted' );
static $compositePrimaryKey=array();
static $uploadDependency = array();
/*this array contains the fields that are unique*/
static $uniqueArray=array();
/*this is an associative array containing the fieldname and the type of the field*/
static $typeArray = array('student_id'=>'int','course_id'=>'int','course_unit'=>'int','course_status'=>'varchar','semester'=>'int','session_id'=>'int','student_level'=>'int','ca_score'=>'int','exam_score'=>'int','total_score'=>'int','is_approved'=>'tinyint','date_last_update'=>'datetime','date_created'=>'datetime','date_deleted'=>'timestamp');
/*this is a dictionary that map a field name with the label name that will be shown in a form*/
static $labelArray=array('id'=>'','student_id'=>'','course_id'=>'','course_unit'=>'','course_status'=>'','semester'=>'','session_id'=>'','student_level'=>'','ca_score'=>'','exam_score'=>'','total_score'=>'','is_approved'=>'','date_last_update'=>'','date_created'=>'','date_deleted'=>'');
/*associative array of fields that have default value*/
static $defaultArray = array('date_deleted'=>'current_timestamp()');
...
static $tableAction=array('delete'=>'delete/course_enrollment_archive','edit'=>'edit/course_enrollment_archive');
...
function getDate_deletedFormField($value=''){
