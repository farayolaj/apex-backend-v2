 ...
 */
final class Templates implements Observer
{
    // ---- INSERT FLOW ----
    ...
    public function afterCreated(int $id, array &$data, array $extra): void {
        logAction('create_template', $extra['current_user']->user_login, null, null, json_encode($data));
    }
    ...
    public function afterUpdated(int $id, array &$data, array $extra): void {
        logAction('edit_template', $extra['current_user']->user_login, null, null, json_encode($data));
    }
    ...
    public function afterDeleted(int $id, array $extra): void {
        ...
        logAction('delete_template', $extra['current_user']->user_login, $id, $record);
    }
}
