...
class FormConfig
{
    ...
    public bool $currentRole;

    private bool $apiEntity = false;
    ...
    /**
     * this is the function to change when an entry for a particular entity needed to be added. this is only necessary for entities that has a custom configuration for the form.Each of the key for the form model append insert option is included. This option inculde:
     ...
     * the query parameter is used to specify a query for getting the data out of the entity
    ...
    private function getFilter($tablename)
    {
        $result = array(
            ...
            'course_manager' => array(
                ...
                array(
                    'filter_label' => 'api_department',
                    'filter_display' => 'api_department',
                    'preload_query' => null,
                ),
                array(
                    'filter_label' => 'f.id',
            ...
            'staffs' => array(
                array(
                    'filter_label' => 'c.id',
                    'filter_display' => 'department_id',
                    'preload_query' => null,
                ),
                array(
                    'filter_label' => 'd.id',
                    'filter_display' => 'unit_id',
                    'preload_query' => null,
                ),
            ),
            'course_mapping' => array(
                array(
                    'filter_label' => 'semester',
                    'filter_display' => 'semester',
                    'preload_query' => null,
                ),
            ),
            'course_configuration' => array(
                array(
                    'filter_label' => 'semester',
                    'filter_display' => 'semester',
                    'preload_query' => null,
     ...
     */
    private function buildUpdateConfig(): void
    {
