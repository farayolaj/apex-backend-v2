...
class MatrixHttpApi
{
    ...
    private function send(
        ...
        array $queryParams = [],
        array $headers = [],
        $apiPath = self::MATRIX_V2_API_PATH,
        $returnJson = true
    ) {
        $options = [];
        ...
        while (true) {
            ...
            $waitTime /= 1000;
            log_message("info", "[matrix] set wait time: $waitTime");
            sleep((int)$waitTime);
        }
