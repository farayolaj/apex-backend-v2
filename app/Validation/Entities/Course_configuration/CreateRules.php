...
/**
 * Validation rules for Course_configuration (create).
...
final class CreateRules implements RulesProvider
{
    ...
    {
        return permissionAuthorize($ctx['__authorize__'] ?? 'course_config_create');
    }
    ...
    public static function rules(): array
    {
        return [
            ...
            'enable_reg' => ['label' => 'course reg. status', 'rules' => 'required|in_list[1,0]'],
        ];
    }
