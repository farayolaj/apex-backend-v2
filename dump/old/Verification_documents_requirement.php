...
* And it represent the model of the verification_documents_requirement table
*/
class Verification_documents_requirement extends Crud {

/** 
* This is the entity name equivalent to the table name
* @var string
*/
protected static $tablename = "Verification_documents_requirement"; 

/** 
* This array contains the field that can be null
* @var array
*/
public static $nullArray = ['description','date_created','status'];
...
* @var array
*/
public static $typeArray = ['name' => 'varchar','description' => 'text','status' => 'tinyint','date_created' => 'timestamp'];
...
* @var array
*/
public static $labelArray = ['ID' => '','name' => '','description' => '','status' => '','date_created' => ''];
...
* @var array
*/
public static $tableAction = ['delete' => 'delete/verification_documents_requirement', 'edit' => 'edit/verification_documents_requirement'];
